...
class ClosureCalc(tk.Tk):
    ...
    def __init__(self):
        ...
        self.closure_run = closure_calculator(self)
    ...
    def gen_report(self):
        ...
        if not self.closure_run.has_closure_results():
            return
        ...
        if file_path:
            write_report_to_file(file_path,report_name,self.closure_run.closure_stats,self.closure_run.direct_points)
    ...
    def save_csv(self):
        ...
        if file_path:
            f = open(file_path,"w")
            index = 1
            for i in self.closure_run.direct_points:
